...
type PaginationPreviousProps = React.ComponentPropsWithoutRef<typeof PaginationLink>
...
type PaginationNextProps = React.ComponentPropsWithoutRef<typeof PaginationLink>
