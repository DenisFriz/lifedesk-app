          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="basic" className="space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <Button onClick={() => inputDigit(7)} variant="outline" className="h-14 text-lg">
                  7
                </Button>
                <Button onClick={() => inputDigit(8)} variant="outline" className="h-14 text-lg">
                  8
                </Button>
                <Button onClick={() => inputDigit(9)} variant="outline" className="h-14 text-lg">
                  9
                </Button>
                <Button
                  onClick={() => performOperation('*')}
                ...
                <Button onClick={() => inputDigit(4)} variant="outline" className="h-14 text-lg">
                  4
                </Button>
                <Button onClick={() => inputDigit(5)} variant="outline" className="h-14 text-lg">
                  5
                </Button>
                <Button onClick={() => inputDigit(6)} variant="outline" className="h-14 text-lg">
                  6
                </Button>
                <Button
                  onClick={() => performOperation('-')}
                ...
                <Button onClick={() => inputDigit(1)} variant="outline" className="h-14 text-lg">
                  1
                </Button>
                <Button onClick={() => inputDigit(2)} variant="outline" className="h-14 text-lg">
                  2
                </Button>
                <Button onClick={() => inputDigit(3)} variant="outline" className="h-14 text-lg">
                  3
                </Button>
                <Button
                  onClick={() => performOperation('+')}
            ...
            <TabsContent value="history" className="space-y-2">
              {history.length === 0 ? (
                <div className="text-center py-8 text-slate-500 text-sm">No calculations yet</div>
              ) : (
                <div className="space-y-2">
                  {history.map(item => (
                    <div key={item._id} className="bg-slate-50 rounded-lg p-3 text-sm space-y-1">
