...
export default function AIAssistantPanel({
  ...
  // Desktop path - wrap both upgrade and enabled states in AnimatePresence
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {!aiEnabled ? (
            <motion.div
              ...
              className="fixed top-0 bottom-0 z-40 w-96 bg-white shadow-2xl flex flex-col hidden lg:flex"
            >
              <div className="p-4 border-b border-slate-200 flex items-center justify-between bg-gradient-to-r from-indigo-50 to-purple-50">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center">
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center px-8 gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-slate-900 text-lg mb-2">AI Assistant</h4>
                  <p className="text-sm text-slate-500">
                    The AI Assistant is available on PRO plan. Upgrade to unlock intelligent
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50">
                {messages.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center text-slate-500 px-4">
                    ...
                    <p className="font-medium">Ask me anything</p>
                    <p className="text-sm mt-2">
                      I have access to all your data: health, fitness, business, finances, goals,
                      and more
                    </p>
                  </div>
                ) : (
              ...
              <div className="p-4 border-t border-slate-200 bg-white space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    onClick={handleSend}
                    disabled={
                      (!input.trim() && uploadedImages.length === 0) || chatMutation.isPending
                    }
                    size="icon"
                    className="bg-indigo-600 hover:bg-indigo-700 flex-shrink-0"
                  >
                ...
                <p className="text-xs text-slate-500 text-center">
                  Analyzes all your app data & images
                </p>
              </div>
            </motion.div>
          )}
