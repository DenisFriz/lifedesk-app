...
export default function Tasks() {
  ...
  const { data: tasks = [], isLoading } = useQuery({
    queryKey: ['tasks'],
    queryFn: () => backend.entities.Task.filter({ category: 'business' }, '-created_date')
  })
  ...
  const handleSubmit = formData => {
    if (editingTask) {
      updateMutation.mutate({ id: editingTask.id, data: { ...formData, category: 'business' } })
    } else {
      createMutation.mutate({ ...formData, category: 'business' })
    }
  }
