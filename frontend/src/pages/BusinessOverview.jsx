...
export default function BusinessOverview() {
  ...
  const { data: business } = useQuery({
    ...
    queryFn: async () => {
      ...
      const businesses = await backend.entities.Business.filter({ is_deleted: false })
  ...
  const { data: projects = [] } = useQuery({
    ...
    queryFn: () =>
      businessId
        ? backend.entities.Project.filter({ business_id: businessId, is_deleted: false })
        : backend.entities.Project.filter({ is_deleted: false }, '-created_date')
  })
  ...
  const { data: clients = [] } = useQuery({
    ...
    queryFn: () =>
      businessId
        ? backend.entities.Client.filter({ business_id: businessId, is_deleted: false })
        : backend.entities.Client.filter({ is_deleted: false }, '-created_date')
  })
  ...
  const { data: tasks = [] } = useQuery({
    ...
    queryFn: () =>
      businessId
        ? backend.entities.Task.filter({
            category: 'business',
            business_id: businessId,
            is_deleted: false
          })
        : backend.entities.Task.filter({ category: 'business', is_deleted: false })
  })
