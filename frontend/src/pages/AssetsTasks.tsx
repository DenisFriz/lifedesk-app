...
export default function AssetsTasks() {
  ...
  return (
    <>
      <Helmet>
        <title>Assets Tasks | LifeDesk</title>
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {isScrolled && (
            <div className="lg:hidden sticky top-[52px] z-20 bg-white border-b border-slate-200 shadow-sm -mx-4 sm:-mx-6 px-4 sm:px-6">
              <div className="py-3">
                <h1 className="text-sm font-normal text-slate-900 text-center">Assets Tasks</h1>
              </div>
            </div>
          )}
          <div ref={headerRef} className="py-6 sm:py-8">
            ...
            <p className="text-sm sm:text-base text-slate-600 text-center lg:text-left">
              Manage your asset-related action items
            </p>
          </div>

          <TaskTable filterType="category" category="assets" />
        </div>
      </div>
    </>
  )
