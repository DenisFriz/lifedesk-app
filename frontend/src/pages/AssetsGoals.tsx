...
export default function AssetsGoals() {
  ...
  return (
    <>
      <Helmet>
        <title>Assets Goals | LifeDesk</title>
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {isScrolled && (
            <div className="lg:hidden sticky top-[52px] z-20 bg-white border-b border-slate-200 shadow-sm -mx-4 sm:-mx-6 px-4 sm:px-6">
              <div className="py-3">
                <h1 className="text-sm font-normal text-slate-900 text-center">Assets Goals</h1>
              </div>
            </div>
          )}
          <div ref={headerRef} className="py-6 sm:py-8">
            ...
            <p className="text-sm sm:text-base text-slate-600 text-center lg:text-left">
              Set and achieve your asset-related objectives
            </p>
          </div>
