...
export default function Relationships() {
  ...
  const { data: contacts = [] } = useQuery({
    queryKey: ['contacts'],
    queryFn: () => backend.entities.Contact.filter({ status: 'active', is_deleted: false }, 'name')
  })
  ...
  const createMutation = useMutation({
    mutationFn: data => backend.entities.Contact.create(data),
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }) => backend.entities.Contact.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['contacts'] })
      setShowForm(false)
  ...
  const deleteMutation = useMutation({
    mutationFn: id => backend.entities.Contact.delete(id),
