...
export default function HealthDocuments() {
  ...
  const { data: documents = [], isLoading } = useQuery({
    ...
    queryFn: () => backend.entities.MedicalDocument.list('-date')
  })
  ...
  const deleteMutation = useMutation({
    mutationFn: id => backend.entities.MedicalDocument.delete(id),
    onSuccess: () => {
  ...
  const archiveMutation = useMutation({
    mutationFn: id => backend.entities.MedicalDocument.update(id, { is_archived: true }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['medicalDocuments'] })
  ...
  const restoreMutation = useMutation({
    mutationFn: id => backend.entities.MedicalDocument.update(id, { is_archived: false }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['medicalDocuments'] })
...
function MedicalDocumentUploadDialog({ open, onOpenChange }) {
  ...
  const createMutation = useMutation({
    mutationFn: data => backend.entities.MedicalDocument.create(data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['medicalDocuments'] })
      onOpenChange(false)
      setFormData({
